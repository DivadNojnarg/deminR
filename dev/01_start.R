...
golem::fill_desc(
  pkg_name = "deminR", # The Name of the package containing the App 
  pkg_title = "deminR", # The Title of the package containing the App 
  pkg_description = "Minesweeper game inside a Shiny app.", # The Description of the package containing the App 
